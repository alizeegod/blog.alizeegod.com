...
module.exports = {
  title: "Alizeegod's blog",
  description: 'web前端技术博客', // 描述,以 <meta> 标签渲染到页面html中
  ...
  themeConfig: { // 主题配置
    ...
    logo: '/img/dota2-logo.jpg', // 导航栏logo
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:alizeegod@163.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/alizeegod'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'Evan Xu | <a href="https://github.com/alizeegod/blog.alizeegod.com/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
